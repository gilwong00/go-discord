...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/gilwong00/go-discord/gen/proto/server/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	ServerServiceName = "server.v1.ServerService"
)
...
const (
	...
	// CreateServer RPC.
	ServerServiceCreateServerProcedure = "/server.v1.ServerService/CreateServer"
)

// ServerServiceClient is a client for the server.v1.ServerService service.
type ServerServiceClient interface {
	CreateServer(context.Context, *connect.Request[v1.CreateServerRequest]) (*connect.Response[v1.CreateServerResponse], error)
}

// NewServerServiceClient constructs a client for the server.v1.ServerService service. By default,
...
// CreateServer calls server.v1.ServerService.CreateServer.
...
// ServerServiceHandler is an implementation of the server.v1.ServerService service.
...
func NewServerServiceHandler(svc ServerServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/server.v1.ServerService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedServerServiceHandler) CreateServer(context.Context, *connect.Request[v1.CreateServerRequest]) (*connect.Response[v1.CreateServerResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("server.v1.ServerService.CreateServer is not implemented"))
}
